<script src="<%=assetspath%>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<%=assetspath%>vendor/popper.min.js"></script>
<script src="<%=assetspath%>vendor/jquery-3.6.0.min.js"></script>
<script src="<%=assetspath%>vendor/bootstrap.min.js"></script>
