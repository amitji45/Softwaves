...
<body>
	...
	<script>
		function findActiveBatches() {
			var url = "http://localhost:9098/valunteer/findActivebatches";
		...
		function updateBatchList(batches1) {
			...
			batches1
					.forEach(function(batch) {
						...
						var url = "http://localhost:9098/valunteer/findallstudent?batchId=";
		...
		function studentpresent(rollNo) {
			...
			url = "http://localhost:9098/valunteer/studentattendence/present?rollNo=";

			markAttendence(rollNo, url);
		}
		function studentabsent(rollNo) {
			console.log("studentabsent call....");
			url = "http://localhost:9098/valunteer/studentattendence/absent?rollNo=";
			markAttendence(rollNo, url);
		}
