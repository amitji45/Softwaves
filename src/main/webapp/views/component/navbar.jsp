	...
	<div
		...
		<script type="text/javascript">
			function createBatch(batch_name) {
				url = "http://localhost:9098/admin/newbatch?name=";
			...
			function findEnrollBatche() {
				...
				var url = "http://localhost:9098/user/allbatches";
				var xhttp = new XMLHttpRequest();
				xhttp.onreadystatechange = function() {
					if (this.readyState === 4 && this.status === 200) {
						...
						console.error("Error: aman" + this.status + " "
								+ this.statusText);
					}
				};
			...
			function updateEnrollBatchList(batches) {
				...
				batches.forEach(function(batch) {
					...
					url = "http://localhost:9098/user/enrollstudent?batchId=";
