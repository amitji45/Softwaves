...
public class AdminController {
	...
	public Model startbatch(@RequestParam("id") String batchId,HttpServletRequest request,Model model) {
	...
	public Model endbatch(@RequestParam("id") String batchId,HttpServletRequest request,Model model) {
